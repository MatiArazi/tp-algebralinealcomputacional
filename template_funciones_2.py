...
def metpot1(A,tol=1e-8,maxrep=np.inf):
   ...
   l = calcula_lambda(A,v) # Calculamos el autovector estimado
   l1 = calcula_lambda(A,v1) # Y el estimado en el siguiente paso
   nrep = 1 # Contador
...
def laplaciano_iterativo(A,niveles,nombres_s=None):
    ...
    if A.shape[0] == 1 or niveles == 0: # Si llegamos al último paso, retornamos los nombres en una lista
        ...
        v,l,_ = metpotI2(L,1e-3) # Encontramos el segundo autovector de L
